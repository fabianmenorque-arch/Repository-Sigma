...
function sigmaRenderNav(activePage, basePath = ""){
  ...
  <nav class="sigma-nav">
    <div class="brand">
      <img src="${basePath}assets/isotipo.svg" alt="" width="30" height="30" style="border-radius:6px;">
      SIGMA <small>Ingenio Bella Vista</small>
    </div>
...
function sigmaSetFavicon(basePath = ""){
  ...
  link.href = `${basePath}assets/isotipo.svg`;
