...
- `crear_orden` → agrega fila a `Ordenes_de_Trabajo` (genera `Nro_Orden` si falta)
- `actualizar_orden` → busca por `Nro_Orden` y actualiza los campos recibidos (Estado, Fecha_Cierre_Real, etc.)
