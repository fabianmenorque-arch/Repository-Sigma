...
function actualizarOrden_(body) {
  ...
  // automáticamente el registro correspondiente en Mantenimientos, para
  // que alimente los KPIs del dashboard sin cargar todo dos veces.
  ...
  if (nuevoEstado === "Completada" && estadoAnterior !== "Completada") {
    ...
    crearMantenimiento_({
      ...
      Fecha_Inicio: ordenActual.Fecha_Creacion,
